...
class View {
  ...
  setupBoard() {
    ...
    $intro.attr('id','intro');
    const $start = $("<button class='w3-amber w3-padding-large w3-large w3-margin-top'>Start</button>");
  ...
  displayLosing() {
    ...
    const $ul = $("<ul>Oops! Try Again<br/><button class='w3-button w3-amber w3-padding-large w3-large w3-margin-top' onclick='location.reload()'>Play Again</button></ul>");
