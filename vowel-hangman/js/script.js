...
var animals = ["elephant", "kitten", "tiger", "porcupine", "kangaroo"];
var countries = ["China", "Canada", "Afghanistan", "Zimbabwe", "Australia"];
var fruits = ["jackfruit", "watermelon", "strawberry", "blueberry", "pineapple"];
var sports = ["golf", "boxing", "surfing", "badminton", "wrestling"];

//Concatenate Arrays into Categorys Array
var categories = [animals, countries, fruits, sports];
	...
	if (newWord === word) {
		...
		if (show.indexOf(char) > -1) {
			if (char !== "a" && char !== "e" && char !== "i" && char !== "o" && char !== "u") {
				$("#status").html('<div class="alert alert-warning center"><strong>Warning: </strong>The consonants of the word are already given to you.</span>');
			} else {
